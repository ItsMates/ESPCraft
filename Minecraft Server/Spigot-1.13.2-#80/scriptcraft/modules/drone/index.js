...
Drone.prototype.onecube = function (block, immediate) {
    var bm = this.getBlockIdAndMeta(block);

    if (!immediate) {
        this.then(function () {
            traverseDHW(this, 1, 1, 1, function () {
                this.setBlock(bm[0], bm[1], 0, 0, 0, true);
            });
        });
    } else {
        traverseDHW(this, 1, 1, 1, function () {
...
Drone.extend('place', Drone.prototype.onecube);
